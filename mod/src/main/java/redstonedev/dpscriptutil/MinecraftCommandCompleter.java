...
public class MinecraftCommandCompleter implements Completer {
	...
	public MinecraftCommandCompleter(CommandDispatcher<CommandSourceStack> cmdDispatcher, CommandSourceStack cmdSrc) {
	...
	public void complete(LineReader reader, ParsedLine line, List<Candidate> candidates) {
		...
		//get the suggestions
		ParseResults<CommandSourceStack> parseRes = cmdDispatcher.parse(inputBuf[1], cmdSrc);
